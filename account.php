...
<html>
    <head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="a/calendar.css">
            ...
            <div id=header>
                    <ul id="links">
						 ...
						 <li class="opdrachten"><a href="kalender.php">Home</a></li>
                        						 ...
                        						 <li class="" id="logged-in"><a class="grav_small_a" href="account.php"><?								
								$email = $account_email;
                    ...
                    <section>
                        <article>
							<?PHP 
								...
								echo $gravatar;
							?>
							Wil je een profiel foto hier? Ga dan naar <a href="http://gravatar.com">Gravatar.com</a>
							<br /><br />
							Full name = <?= $fgmembersite->UserFullName();
							?>
							<br />
							Email= <?= $fgmembersite->UserEmail();?>
							<br />
							IP= <?= $fgmembersite->checkIP()?>
                        </article>
                    </section>
                </div>
                <div id="side">
